...
// //////// shiftr.io desktop client. 
// // Fill in your desktop IP address for localhost:
// // const broker = 'ws://10.23.10.135:1883';     
...
// // topic to subscribe to when you connect:
// let topic = 'conndev/apoorva';
// // let topic1 = 'conndev/apoorva/rssi';
// // let topic2 = 'conndev/apoorva/bssid';
// // let topic1 = 'conndev/rssi';
// // let topic2 = 'conndev/bssid';
// // divs to show messages:
// let localDiv, rssiDiv, bssidDiv;
// // whether the client should be publishing or not:
// let publishing = false;
...
//   // put the divs in variables for ease of use:
//   localDiv = document.getElementById('local');
//   rssiDiv = document.getElementById('rssi');
//   bssidDiv = document.getElementById('bssid');
...
//     // publish to broker:
//     client.publish(topic, thisMessage);
//     // client.publish(topic1, thisMessage);
//     // client.publish(topic2, thisMessage);
//     // update localDiv text:
//     localDiv.innerHTML = 'published to broker.'
//   }
// }
...
//   // subscribe to the topic:
//   client.subscribe(topic, onSubscribe);
//   // client.subscribe(topic1, onSubscribe);
//   // client.subscribe(topic2, onSubscribe);
// }
